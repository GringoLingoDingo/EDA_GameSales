...
Este repositorio contiene un análisis de ventas de videojuegos con el objetivo de encontrar patrones que permitan predecir o explicar el éxito de un título independiente. La hipótesis principal se basa en la relación entre reseñas (tanto de usuarios como de críticos) y las ventas de los juegos.
...
Correlación entre el número de reseñas positivas y las ventas.

Análisis de la influencia de las reseñas de críticos versus las reseñas de usuarios.

Impacto de la cantidad total de reseñas en el crecimiento de las ventas a lo largo del tiempo.
